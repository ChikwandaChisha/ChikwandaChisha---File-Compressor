...
public class HuffmanImplementation implements Huffman{
    ...
    public static void main(String[] args) throws IOException {
        ...
        Map<Character, Long> map= compress.countFrequencies("Files/USConstitution.txt");Map<Character, String> mapcode= compress.computeCodes(compress.makeCodeTree(map));
        compress.compressFile(mapcode,"Files/USConstitution.txt","Files/USConstitution_compressedfile.txt");
        compress.decompressFile("Files/USConstitution_compressedfile.txt","Files/USConstitution_decompressedfile.txt",compress.makeCodeTree(map));

        Map<Character, Long> map2= compress.countFrequencies("Files/WarAndPeace");Map<Character, String> mapcode2=compress.computeCodes(compress.makeCodeTree(map2));
        compress.compressFile(mapcode2,"Files/WarAndPeace","Files/WarAndPeace_compressedfile.txt");
        compress.decompressFile("Files/WarAndPeace_compressedfile.txt","Files/WarAndPeace_decompressedfile.txt",compress.makeCodeTree(map2));
    }
}
